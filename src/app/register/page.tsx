...
// 🔥 FIX 1: Main లాజిక్ మొత్తాన్ని RegisterContent అనే ఇన్నర్ కంపోనెంట్ లోకి మార్చాము
function RegisterContent() {
  ...
  // 🔥 FIX 2: Theme Sync - Global Store నుండి థీమ్ తీసుకుంటున్నాం
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          {isDarkMode && (
            <>
              {/* 🔥 FIX 3: Performance కోసం transform-gpu మరియు will-change-transform యాడ్ చేశాం */}
              <motion.div
                animate={blobAnimation.animate}
                transition={blobAnimation.transition}
        ...
        >
          ...
          {/* ================= RIGHT SIDE (FORM + NAVBAR INCLUDED) ================= */}
          {/* 🔥 FIX 5: Scroll అవుతున్నప్పుడు lag అవ్వకుండా transform-gpu యాడ్ చేసాం */}
          <div
...
// 🔥 FIX 4: అసలైన పేజీకి Suspense యాడ్ చేసాము. ఇది Next.js Build Error ని సాల్వ్ చేస్తుంది.
export default function RegisterPage() {
  return (
    <Suspense
      fallback={
